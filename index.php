...
<body>
                ...
                <div id="sub-view-settings" class="sub-view-section" style="display: none; flex-direction: column; gap: 16px;">
                    <div class="grid-2">
                        <div class="card">
                            ...
                            <h2 style="margin-top: 10px;">Admin Movement Clips</h2>
                            <div id="movement-clip-list" style="display:flex; flex-direction:column; gap:6px; max-height:180px; overflow-y:auto; border:1px solid var(--border); border-radius:6px; padding:8px; background:var(--bg); font-size:12px;">
    ...
    <script>
        ...
        function initiateContinuousInferenceEngineLoop() {
            ...
            const intervalMs = (motionTrackingEnabled || manualRecordingInstance || motionRecordingInstance) ? 650 : 300;
